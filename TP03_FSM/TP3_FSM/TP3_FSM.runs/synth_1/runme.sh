...
HD_PWD='E:/Formation_SAFRAN/Composant_FPGA/Doriane/TP03_FSM/TP3_FSM/TP3_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tp_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tp_fsm.tcl
